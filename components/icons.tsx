...
export const BuildingIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0v-4m6 4v-4m6 4v-4m-9-4h5m-4-4h2" />
  </svg>
);
...
export const MountainIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h18M3.472 17.528L8.05 13.05m5.9 0l5.528 4.478M8.05 13.05l2.472-2.472m3.428 2.472l2.472-2.472M12 3v10.05" />
  </svg>
);

export const WaveIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 12h16M4 18h16" transform="matrix(1,0,0,1,0,-2) translate(0, 2) rotate(0) skewX(20) skewY(0) scale(1, 1)"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 8h16M4 14h16" transform="matrix(1,0,0,1,0,-2) translate(0, 2) rotate(0) skewX(-20) skewY(0) scale(1, 1)"/>
    </svg>
);

export const RiverIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 4.75s2.5-1.75 6-1.75 6 1.75 6 1.75 2.5-1.75 6-1.75M4 10.75s2.5-1.75 6-1.75 6 1.75 6 1.75 2.5-1.75 6-1.75M4 16.75s2.5-1.75 6-1.75 6 1.75 6 1.75 2.5-1.75 6-1.75" />
    </svg>
);
...
export const NewspaperIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4 12H9m-4 0H5m4 0v-4m0 4h5m5-12v-2m0 2h2m-2 0h-2" />
    </svg>
);
...
export const ShieldIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0 3.517-1.009 6.78-2.75 9.565C6.54 22.999 2 22.999 2 12V5.445c0-.822.583-1.532 1.391-1.78L12 1l8.609 2.665c.808.248 1.391.958 1.391 1.78V12c0 10.999-4.54 10.999-7.25 8.565C13.009 17.78 12 14.517 12 11z" />
  </svg>
);
...
export const HeartbeatIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 12h3.5l2.5-6 4 12 2.5-6 2.5 6H20" />
  </svg>
);

export const TaiwanIcon: React.FC<IconProps> = ({ className }) => (
